...
export const ASSET_CATEGORIES: Record<AssetCategory, CategoryInfo> = {
  anime: {
    ...
    metaDescription: '100% free original anime Discord banners and matching profile pictures. Handcrafted aesthetic anime safe-zone templates, animated banners, and seamless profile sets.',
  ...
  gaming: {
    ...
    shortName: 'Gaming',
    slug: 'gaming',
    seoTitle: 'Discord Gaming Banners & Server Header Templates | Asset Studio',
  ...
  dark: {
    ...
    shortName: 'Dark',
    slug: 'dark',
    seoTitle: 'Dark Aesthetic Discord Banners & Gothic Matching PFPs | Studio',
